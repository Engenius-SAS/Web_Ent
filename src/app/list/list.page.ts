...
// ------------------------------------------------------------
  ...
  exportAsXLSX() {
    ...
    this.Toexcel =  [['Id Encuesta' , 'Fecha Encuesta' , 'Nombre Encuestado', 'Telefono Encuestado', 'Municipio', 'Vereda', 'Latitud', 'Longitud', 'Altitud', 'Nombre Encuestador', 'Telefono Encuestador']];
