...
@Component({
  selector: 'app-list-ag',
  templateUrl: './list-ag.page.html',
  styleUrls: ['./list-ag.page.scss'],
})
export class ListAgPage implements OnInit {
  Pines;
  Encuesta;
  usuario = '0';
  ...
  municipio;
    ...
    this.global.consultar(pdata3, (err3, response3) => {
      ...
      this.Muni = response3;
        ...
        this.global.consultar(pdata8, (err8, response8) => {
          ...
          const pdata9 = {option: 'MapaAg', Id_Proyecto: this.global.Id_Proyecto};
          this.global.consultar(pdata9, (err9, response9) => {
            console.log('ENCUESTAS', response9);
            this.Pines = this.users = response9;
            console.log('id EXCEL', this.global.Id_Proyecto);                  
            const pdata10 = {option: 'excellAg', Id_Proyecto: this.global.Id_Proyecto};
            this.global.consultar(pdata10, (err10, response10) => {
              console.log('ENCUESTAS EXCEL', response10);
    ...
    VerDetalles(item) {
      ...
      this.navCtrl.navigateRoot('/verencuesta-ag');
    }
  ...
  cargarEncAg() {
    ...
    this.global.consultar(pdata9, (err9, response9) => {
      console.log('ENCUESTADORESAg', response9);
    ...
    BuscarE() {
      ...
      if (this.usuario == '0') {
        this.Pines = new Array();
          setTimeout(() => {
            const pdata8 = {option: 'MapaAg', Id_Proyecto: this.global.Id_Proyecto};
            this.global.consultar(pdata8, (err8, response8) => {
              console.log('PINES MAPAAg', response8);
        ...
        this.Pines = new Array();
       setTimeout(() => {
            const pdata8 = {option: 'MapaAg2', userpro: this.usuario, Id_Proyecto: this.global.Id_Proyecto};
            console.log(pdata8);
            this.global.consultar(pdata8, (err8, response8) => {
              console.log('PINES MAPAAg', response8);
              this.Pines = response8;
      ...
      if (this.municipio == '0') {
       ...
       setTimeout(() => {
        ...
        setTimeout(() => {
            ...
            const pdata8 = {option: 'MapaMAg', Id_Proyecto: this.global.Id_Proyecto, municipio: this.municipio};
            this.global.consultar(pdata8, (err8, response8) => {
              console.log('PINES MAPAAg', response8);
    ...
    async VerFotos(item) {
      ...
      const popover = await this.popoverController.create({
        component: ImagesviewAgComponent,
        translucent: true
      });
    ...
    Descargar(item) {
      console.log('ID', this.global.Id_Proyecto);      
    try {
      ...
      setTimeout(() => {
        ...
        this.global.consultar(pdata8, (err8, response8) => {
          ...
          Pag1.crossOrigin = '';
          Pag1.src = 'assets/imgs/encuesta2/p1.png';
          const Pag2 = new Image();
          Pag2.crossOrigin = '';
          Pag2.src = 'assets/imgs/encuesta2/p2.png';
          const Pag3 = new Image();
          Pag3.crossOrigin = '';
          Pag3.src = 'assets/imgs/encuesta2/p3.png';
          const Pag4 = new Image();
          Pag4.crossOrigin = '';
          Pag4.src = 'assets/imgs/encuesta2/p4.png';
          const Pag5 = new Image();
          Pag5.crossOrigin = '';
          Pag5.src = 'assets/imgs/encuesta2/p5.png';
          const Pag6 = new Image();
          Pag6.crossOrigin = '';
          Pag6.src = 'assets/imgs/encuesta2/p6.png';
          const Pag7 = new Image();
          Pag7.crossOrigin = '';
          Pag7.src = 'assets/imgs/encuesta2/p7.png';
          const Pag8 = new Image();
          Pag8.crossOrigin = '';
          Pag8.src = 'assets/imgs/encuesta2/p8.png';
          const Pag9 = new Image();
          Pag9.crossOrigin = '';
          Pag9.src = 'assets/imgs/encuesta2/p9.png';
          const Pag10 = new Image();
          Pag10.crossOrigin = '';
          Pag10.src = 'assets/imgs/encuesta2/p10.png';
          const Pag11 = new Image();
          Pag11.crossOrigin = '';
          Pag11.src = 'assets/imgs/encuesta2/p11.png';
          const Pag12 = new Image();
          Pag12.crossOrigin = '';
          Pag12.src = 'assets/imgs/encuesta2/p12.png';
          const Pag13 = new Image();
          Pag13.crossOrigin = '';
          Pag13.src = 'assets/imgs/encuesta2/p13.png';
          const Pag14 = new Image();
          Pag14.crossOrigin = '';
          Pag14.src = 'assets/imgs/encuesta2/p14.png';
          const Pag15 = new Image();
          Pag15.crossOrigin = '';
          Pag15.src = 'assets/imgs/encuesta2/p15.png';
  ...
  // ------------------------------------------------------------
    ...
    exportAsXLSX() {
      ...
      this.Toexcel =  [['Id Encuesta' , 'Fecha Encuesta', 'Municipio', 'Vereda', 'Latitud', 'Longitud', 'Altitud', 'Nombre Encuestador', 'Telefono Encuestador']];
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          this.Toexcel = [['Id Encuesta' , 'Fecha Encuesta' , 'Telefono Encuestado', 'Municipio', 'Vereda', 'Latitud', 'Longitud', 'Altitud', 'Nombre Encuestador', 'Telefono Encuestador']];
        }, 1000);
      }, 1500);
    }
}
