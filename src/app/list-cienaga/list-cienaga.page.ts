...
@Component({
  selector: 'app-list-cienaga',
  templateUrl: './list-cienaga.page.html',
  styleUrls: ['./list-cienaga.page.scss'],
})
export class ListCienagaPage implements OnInit {
  Pines;
  Encuesta;
  usuario = '0';
  ...
  cargarEnc() {
    ...
    BuscarE() {
      if (this.usuario == '0') {
        ...
        this.loading.LoadingNormal('Consultando');
        setTimeout(() => {
          const pdata8 = {option: 'MapaC2', userpro: this.usuario};
          console.log(pdata8);
          this.global.consultar(pdata8, (err8, response8) => {
            console.log('PINES MAPA', response8);
            this.loading.HideLoading();
